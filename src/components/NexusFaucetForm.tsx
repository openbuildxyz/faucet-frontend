...
const NexusFaucetForm = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await requestToken(address, "NEX");
      if (response?.data?.tx) {
  ...
  const explorer = process.env.NEXT_PUBLIC_NEXUS_EXPLORER
    ...
    <Card className={styles.container}>
      <div className={styles.content}>
        ...
        <div className={styles.contactContainer}>
          <Text className={styles.contact}>Welcome to follow and join the Nexus Community. </Text>
        </div>
      </div>
      <SocialLinks />
    </Card>
...
export default NexusFaucetForm;
