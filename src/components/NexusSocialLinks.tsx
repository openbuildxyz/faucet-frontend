  ...
  return (
    <div className={styles.container}>
      <div className={styles.iconContainer}>
        <SocialLink href="https://github.com/nexus-xyz" icon={<Twitter size={16} />} label="Twitter" />
        <SocialLink href="https://t.me/+GCbWeQwd3tExYzFl" icon={<FaTelegramPlane size={16} />} label="Telegram" />
        <SocialLink href="https://discord.gg/nexus-xyz" icon={<FaDiscord size={16} />} label="Telegram" />
      </div>
    </div>
  )
}
